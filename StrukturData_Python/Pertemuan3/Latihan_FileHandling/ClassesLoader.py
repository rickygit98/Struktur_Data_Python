...
@author: User
'''
from Latihan_FileHandling.TextFile1 import TextFile1
from Latihan_FileHandling.TextFile2 import TextFile2

#--------------------------------------------------------------------------------

from Latihan_FileHandling.RandomNumber import RandomNumber
from Latihan_FileHandling.BacaFileRandom import BacaFileRandom
